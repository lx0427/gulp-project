...
!(function(t) {
  ...
  (function(t, e, n, i) {
    ...
    function _(t) {
      ...
      return new (e = n ? n : Ct ? F : _t ? L : xt ? j : N)(t, b)
    }
    function b(t, e, n) {
    ...
    var wt = s(
      ...
      _t = xt && kt.test(navigator.userAgent),
      bt = 'touch',
      Mt = 'pen',
      Et = 'mouse',
      Dt = 'kinect',
    ...
    ;(t.modal = function(n, i) {
      ...
      var a = n.buttons,
        r = a
          .map(function(t, e) {
            return (
              '<a href="javascript:;" class="weui_btn_dialog ' +
              (t.className || '') +
              '">' +
              t.text +
              '</a>'
          ...
          .join(''),
        o =
          '<div class="weui_dialog"><div class="weui_dialog_hd"><strong class="weui_dialog_title">' +
          n.title +
          '</strong></div>' +
          (n.text ? '<div class="weui_dialog_bd">' + n.text + '</div>' : '') +
          '<div class="weui_dialog_ft">' +
          r +
          '</div></div>',
        s = t.openModal(o, i)
      return (
        s.find('.weui_btn_dialog').each(function(e, i) {
          var r = t(i)
          r.click(function() {
      ...
      (t.closeModal = function() {
        t('.weui_mask_visible')
          .removeClass('weui_mask_visible')
          .transitionEnd(function() {
            t(this).remove()
          }),
          t('.weui_dialog_visible')
            .removeClass('weui_dialog_visible')
            .transitionEnd(function() {
              t(this).remove()
            })
      }),
      ...
      (t.prompt = function(n, i, a, r, o, s) {
        ...
        var l = ''
        l = c.isTextarea
          ? '<textarea class="weui_input weui-prompt-input" placeholder="请输入内容..." style="height:auto;" rows="4" id="weui-prompt-input">' +
            (c.input || '') +
            '</textarea>'
          : '<input type="text" class="weui_input weui-prompt-input" id="weui-prompt-input" value="' +
            (c.input || '') +
            '" />'
        var u = t.modal(
          {
            text: '<p class="weui-prompt-text">' + (c.text || '') + '</p>' + l,
            title: c.title,
            autoClose: !1,
            buttons: [
              {
                ...
                className: 'default',
                onClick: function() {
                  t.closeModal(), c.onCancel && c.onCancel.call(u)
                }
              },
              {
                text: e.buttonOK,
                ...
                onClick: function() {
                  ...
                  return c.empty || ('' !== e && null !== e)
                    ? (t.closeModal(), void (c.onOK && c.onOK.call(u, e)))
                    : (u
                        .find('.weui-prompt-input')
                        .focus()[0]
                        .select(),
                      !1)
                }
        ...
        var l = t.modal(
          {
            text:
              ...
              (c.text || '') +
              '</p><input type="text" class="weui_input weui-prompt-input" id="weui-prompt-username" value="' +
              (c.username || '') +
              '" placeholder="输入用户名" /><input type="password" class="weui_input weui-prompt-input" id="weui-prompt-password" value="' +
              (c.password || '') +
              '" placeholder="输入密码" />',
            title: c.title,
            autoClose: !1,
          ...
          function() {
            this.find('#weui-prompt-username')
              .focus()[0]
              .select()
          }
        )
  ...
  +(function(t) {
    ...
    var e = function(e, n) {
        n = n || ''
        var i = (t("<div class='weui_mask_transparent'></div>").appendTo(
            document.body
          ),
          '<div class="weui_toast ' + n + '">' + e + '</div>'),
          a = t(i).appendTo(document.body)
        a.show(), a.addClass('weui_toast_visible')
      },
      n = function(e) {
        t('.weui_mask_transparent').remove(),
          t('.weui_toast_visible')
            .removeClass('weui_toast_visible')
            .transitionEnd(function() {
              var n = t(this)
              n.remove(), e && e(n)
            })
    ...
    ;(t.toast = function(t, a, r) {
      ...
      'cancel' == a
        ? (o = 'weui_toast_cancel')
        : 'forbidden' == a
        ? (o = 'weui_toast_forbidden')
        : 'text' == a && (o = 'weui_toast_text'),
        e(
          '<i class="weui_icon_toast"></i><p class="weui_toast_content">' +
            (t || '已经完成') +
            '</p>',
          o
        ),
      ...
      (t.showLoading = function(t) {
        for (var n = '<div class="weui_loading">', i = 0; i < 12; i++)
          n +=
            '<div class="weui_loading_leaf weui_loading_leaf_' + i + '"></div>'
        ;(n += '</div>'),
          (n +=
            '<p class="weui_toast_content">' + (t || '数据加载中') + '</p>'),
  ...
  +(function(t) {
    ...
    var e,
      n = function(e) {
        var n = t("<div class='weui_mask weui_actions_mask'></div>").appendTo(
            document.body
          ),
          i = e.actions || [],
          a = i
          ...
          r = ''
        e.title &&
          (r = '<div class="weui_actionsheet_title">' + e.title + '</div>')
        var o =
            '<div class="weui_actionsheet " id="weui_actionsheet">' +
            r +
            '<div class="weui_actionsheet_menu">' +
            a +
            '</div><div class="weui_actionsheet_action"><div class="weui_actionsheet_cell weui_actionsheet_cancel">取消</div></div></div>',
          s = t(o).appendTo(document.body)
        s
          .find(
            '.weui_actionsheet_menu .weui_actionsheet_cell, .weui_actionsheet_action .weui_actionsheet_cell'
          )
          .each(function(n, a) {
            t(a).click(function() {
              t.closeActions(),
      ...
      (e.prototype.touchEnd = function() {
        ;(this.start = !1),
          this.diffY <= 0 ||
            ...
            Math.abs(this.diffY) <= this.distance ||
  ...
  +(function(t) {
    ...
    ;(t.showTab = n),
      t(document).on('click', '.weui_tabbar_item, .weui_navbar_item', function(
        i
      ) {
  ...
  +(function(t) {
    'use strict'
    t(document)
      .on('click', '.weui_search_input', function(e) {
        t(e.target)
          .parents('.weui_search_bar')
          .addClass('weui_search_focusing')
      })
      .on('blur', '.weui_search_input', function(e) {
        var n = t(e.target)
        n.val() ||
          n.parents('.weui_search_bar').removeClass('weui_search_focusing')
      })
      .on('click', '.weui_search_cancel', function(e) {
        t(e.target)
          .parents('.weui_search_bar')
          .removeClass('weui_search_focusing')
          .find('.weui_search_input')
          .val('')
          .blur()
      })
  ...
  +(function(t) {
    ...
    var e = function(e) {
      ...
      function a() {
        if (c.opened)
          for (var t = 0; t < c.cols.length; t++)
            c.cols[t].divider ||
              (c.cols[t].calcSize(), c.cols[t].setValue(c.cols[t].value, 0, !1))
      }
      function r(t) {
        if (
          (t.preventDefault(),
      ...
      var c = this,
        l = {
          ...
          title: '请选择',
          toolbarTemplate:
            '<div class="toolbar">          <div class="toolbar-inner">          <a href="javascript:;" class="clear-button">{{clearText}}</a>          <h1 class="title">{{title}}</h1>      <a href="javascript:;" class="picker-button close-picker">{{closeText}}</a>          </div>          </div>'
        }
      e = e || {}
        ...
        (c.initPickerCol = function(e, n) {
          ...
          function r(e) {
            if (y) {
              ...
              ;(E = b + i),
                (M = void 0),
                E < v && ((E = v - Math.pow(v - E, 0.8)), (M = 'min')),
                E > g && ((E = g + Math.pow(E - g, 0.8)), (M = 'max')),
            ...
            (e =
              ...
              (c.params.toolbar
                ? c.params.toolbarTemplate
                    ...
                    .replace(/{{clearText}}/g, c.params.clearText)
            ...
            e
              ...
              : ((c.container = t(t.openPicker(c.pickerHTML))),
                t(c.container)
                  ...
                  .on('clear', function() {
                    c.params.input &&
                      (t(c.params.input).val(''),
                      t(c.params.input)
                        .attr('data-code', '')
                        .attr('data-codes', '')),
                      c.params.onClear && c.params.onClear(),
                      s()
                  })),
    ...
    t(document).on('click', '.close-picker', function() {
      ...
      t(document).on('click', '.clear-button', function() {
        var e = t('.weui-picker-modal.weui-picker-modal-visible')
        e.length > 0 && t.clearPicker(e)
      }),
        ...
        return this.each(function() {
          if (this) {
            ...
            if (!r) {
              ...
              void 0 === n.value &&
                '' !== o &&
                (n.value = n.cols.length > 1 ? o.split(' ') : [o])
    ...
    ;(n.prototype.initConfig = function() {
      ...
      (n.prototype.open = function(e, n) {
        if (!this._open) {
          this.parseInitValue()
          var i = this.config,
            a = (this.dialog = t.openPicker(
              this.getHTML(),
              t.proxy(this.onClose, this)
            ))
          this._bind(a), (this._open = !0), i.onOpen && i.onOpen(this)
        }
      }),
      (n.prototype.close = function(e, n) {
        var i = this.config.beforeClose
        if (!n) {
          if (
            i &&
            'function' == typeof i &&
            i.call(this, this.data.values, this.data.titles) === !1
          )
            return !1
      ...
      (n.prototype.clear = function(e, n) {
        var i = this
        i.$input.val('').data('values', ''),
          i.$input.attr('value', '').attr('data-values', ''),
          i.onClear(),
          t.closePicker()
      }),
      ...
      (n.prototype.onClear = function() {
        ;(this._open = !1), this.config.onClear && this.config.onClear(this)
      }),
      ...
      (e = t.fn.select.prototype.defaults = {
        ...
        max: void 0,
        toolbarTemplate:
          '<div class="toolbar">      <div class="toolbar-inner">      <a href="javascript:;" class="clear-button">{{clearText}}</a>      <h1 class="title">{{title}}</h1>    <a href="javascript:;" class="picker-button close-select">{{closeText}}</a>      </div>      </div>',
        radioTemplate:
  ...
  +(function(t) {
    ...
    var e,
      ...
      i = function(i) {
        function a() {
          var e = !1
          return u.params.convertToPopover || u.params.onlyInPopover
            ? (!u.inline &&
                u.params.input &&
                (u.params.onlyInPopover
                  ? (e = !0)
                  : t.device.ios
                  ? (e = !!t.device.ipad)
                  : t(window).width() >= 768 && (e = !0)),
        ...
        function r() {
          return !!(
            u.opened &&
            u.container &&
            u.container.length > 0 &&
            u.container.parents('.popover').length > 0
          )
        }
        function o(t) {
          t = new Date(t)
          var e = t.getFullYear(),
            ...
            a = t.getDate(),
            r = t.getDay()
          return u.params.dateFormat
            .replace(/yyyy/g, e)
            .replace(/yy/g, (e + '').substring(2))
            .replace(/mm/g, i < 10 ? '0' + i : i)
            .replace(/m/g, i)
            .replace(/MM/g, u.params.monthNames[n])
            .replace(/M/g, u.params.monthNamesShort[n])
            .replace(/dd/g, a < 10 ? '0' + a : a)
            .replace(/d/g, a)
            .replace(/DD/g, u.params.dayNames[r])
            .replace(/D/g, u.params.dayNamesShort[r])
        }
        function s(t) {
          if (
            (t.preventDefault(),
            !u.opened && (u.open(), u.params.scrollToInput && !a()))
          ) {
        ...
        function l() {
          ;(u.opened = !1),
            u.input &&
              u.input.length > 0 &&
              u.input.parents('.page-content').css({ 'padding-bottom': '' }),
        ...
        return (
          ...
          (u.addValue = function(t) {
            if (u.params.multiple) {
              u.value || (u.value = [])
              for (var e, n = 0; n < u.value.length; n++)
                new Date(t).getTime() === new Date(u.value[n]).getTime() &&
                  (e = n)
          ...
          (u.initCalendarEvents = function() {
            ...
            function i(e) {
              if (o) {
                ...
                ;(C = !1),
                  s ||
                    ((s = !0),
                    (w = u.wrapper[0].offsetWidth),
                    (y = u.wrapper[0].offsetHeight),
            ...
            u.container
              ...
              .on('click', u.prevMonth),
              u.container
                .find('.picker-calendar-next-month')
                .on('click', u.nextMonth),
              u.container
              ...
              u.params.touchMove &&
                (u.wrapper.on(t.touchEvents.start, e),
                u.wrapper.on(t.touchEvents.move, i),
                u.wrapper.on(t.touchEvents.end, a)),
              (u.container[0].f7DestroyCalendarEvents = function() {
                u.container
                  .find('.picker-calendar-prev-month')
                  .off('click', u.prevMonth),
                  u.container
                    .find('.picker-calendar-next-month')
                    .off('click', u.nextMonth),
                  u.container
                    .find('.picker-calendar-prev-year')
                    .off('click', u.prevYear),
                  u.container
                    .find('.picker-calendar-next-year')
                    .off('click', u.nextYear),
                  u.wrapper.off('click', r),
                  u.params.touchMove &&
                    (u.wrapper.off(t.touchEvents.start, e),
                    u.wrapper.off(t.touchEvents.move, i),
                    u.wrapper.off(t.touchEvents.end, a))
              })
          }),
          (u.destroyCalendarEvents = function(t) {
            'f7DestroyCalendarEvents' in u.container[0] &&
              u.container[0].f7DestroyCalendarEvents()
          }),
          ...
          (u.monthHTML = function(t, e) {
            ...
            var s,
              ...
              g = u.params.minDate
                ? new Date(u.params.minDate).getTime()
                : null,
              w = u.params.maxDate ? new Date(u.params.maxDate).getTime() : null
            if (u.value && u.value.length)
              for (c = 0; c < u.value.length; c++)
                p.push(new Date(u.value[c]).setHours(0, 0, 0, 0))
            for (c = 1; c <= h; c++) {
              var y = ''
              for (l = 1; l <= d; l++) {
                var T = l
                ...
                k < 0
                  ...
                  u.params.weekendDays.indexOf(T - 1) >= 0 &&
          ...
          (u.updateCurrentMonthYear = function(t) {
            'undefined' == typeof t
              ? ((u.currentMonth = parseInt(
                  u.months.eq(1).attr('data-month'),
                  10
                )),
                (u.currentYear = parseInt(
                  u.months.eq(1).attr('data-year'),
                  10
                )))
              : ((u.currentMonth = parseInt(
                  u.months
                    .eq('next' === t ? u.months.length - 1 : 0)
                    .attr('data-month'),
                  10
                )),
                (u.currentYear = parseInt(
          ...
          (u.onMonthChangeStart = function(t) {
            ...
            u.months.eq(e).addClass('picker-calendar-month-current'),
              ...
              u.params.onMonthYearChangeStart &&
                u.params.onMonthYearChangeStart(
                  u,
                  u.currentYear,
                  u.currentMonth
            ...
            u.wrapper
              ...
              e
                ? (u.wrapper
                    ...
                    .remove(),
                  (i = u.monthHTML(
                    new Date(u.currentYear, u.currentMonth),
                    'prev'
                  )),
                  (n = u.monthHTML(
                    new Date(u.currentYear, u.currentMonth),
              ...
              u.params.onMonthAdd &&
                u.params.onMonthAdd(
                  u,
                  'next' === t
                    ? u.months.eq(u.months.length - 1)[0]
                    : u.months.eq(0)[0]
                ),
              u.params.onMonthYearChangeEnd &&
                u.params.onMonthYearChangeEnd(u, u.currentYear, u.currentMonth)
          }),
          (u.setMonthsTranslate = function(t) {
            ;(t = t || u.monthsTranslate || 0),
              'undefined' == typeof u.monthsTranslate &&
                (u.monthsTranslate = t),
              u.months.removeClass(
                'picker-calendar-month-current picker-calendar-month-prev picker-calendar-month-next'
              )
          ...
          (u.nextMonth = function(e) {
            ;('undefined' != typeof e && 'object' != typeof e) ||
              ((e = ''), u.params.animate || (e = 0))
            var n = parseInt(
                u.months.eq(u.months.length - 1).attr('data-month'),
                10
              ),
              i = parseInt(
                u.months.eq(u.months.length - 1).attr('data-year'),
                10
              ),
              a = new Date(i, n),
              r = a.getTime(),
              o = !u.animating
            if (u.params.maxDate && r > new Date(u.params.maxDate).getTime())
              return u.resetMonth()
            if ((u.monthsTranslate--, n === u.currentMonth)) {
              var s = 100 * -u.monthsTranslate * h,
                c = t(u.monthHTML(r, 'next'))
                  .transform(
                    'translate3d(' +
                      (u.isH ? s : 0) +
                      '%, ' +
              ...
              u.wrapper.append(c[0]),
                (u.months = u.wrapper.find('.picker-calendar-month')),
                u.params.onMonthAdd &&
                  u.params.onMonthAdd(u, u.months.eq(u.months.length - 1)[0])
            }
          ...
          (u.prevMonth = function(e) {
            ...
            var n = parseInt(u.months.eq(0).attr('data-month'), 10),
              ...
              r = a.getTime(),
              o = !u.animating
            if (u.params.minDate && r < new Date(u.params.minDate).getTime())
              return u.resetMonth()
            if ((u.monthsTranslate++, n === u.currentMonth)) {
              var s = 100 * -u.monthsTranslate * h,
                c = t(u.monthHTML(r, 'prev'))
                  .transform(
                    'translate3d(' +
                      (u.isH ? s : 0) +
                      '%, ' +
          ...
          (u.setYearMonth = function(t, e, n) {
            ...
            if (
              ...
              u.params.maxDate && i > new Date(u.params.maxDate).getTime())
            )
              return !1
            if (u.params.minDate && i < new Date(u.params.minDate).getTime())
              return !1
            ...
            i > a
              ? (u.monthsTranslate--,
                u.animating || u.months.eq(u.months.length - 1).remove(),
                u.wrapper.append(o),
                (u.months = u.wrapper.find('.picker-calendar-month')),
                (s = 100 * -(l - 1) * h),
                u.months
                  .eq(u.months.length - 1)
                  .transform(
                    'translate3d(' +
                      (u.isH ? s : 0) +
                      '%, ' +
                  ...
                  .addClass('picker-calendar-month-next'))
              : (u.monthsTranslate++,
                u.animating || u.months.eq(0).remove(),
                u.wrapper.prepend(o),
                (u.months = u.wrapper.find('.picker-calendar-month')),
                (s = 100 * -(l + 1) * h),
                u.months
          ...
          (u.layout = function() {
            ...
            if (u.params.weekHeader) {
              for (t = 0; t < 7; t++) {
                var l =
                    t + u.params.firstDay > 6
                      ? t - 7 + u.params.firstDay
                      : t + u.params.firstDay,
                  p = u.params.dayNamesShort[l]
                c +=
                  '<div class="picker-calendar-week-day ' +
                  (u.params.weekendDays.indexOf(l) >= 0
            ...
            var h = u.params.toolbar
              ? u.params.toolbarTemplate.replace(
                  /{{closeText}}/g,
                  u.params.toolbarCloseText
                )
              : ''
            u.params.toolbar &&
              (h = u.params.toolbarTemplate
                .replace(/{{closeText}}/g, u.params.toolbarCloseText)
                .replace(
                  /{{monthPicker}}/g,
                  u.params.monthPicker ? u.params.monthPickerTemplate : ''
                )
                .replace(
                  /{{yearPicker}}/g,
                  u.params.yearPicker ? u.params.yearPickerTemplate : ''
                )),
              (e =
                '<div class="' +
                n +
          ...
          u.params.input &&
            ((u.input = t(u.params.input)),
            u.input.length > 0 &&
              (u.params.inputReadOnly && u.input.prop('readOnly', !0),
              u.inline || u.input.on('click', s),
              u.params.inputReadOnly &&
                u.input.on('focus mousedown', function(t) {
                  t.preventDefault()
                }))),
          ...
          (u.open = function() {
            ...
            u.opened ||
              (u.value ||
                (u.params.value && ((u.value = u.params.value), (n = !0))),
              u.layout(),
              e
                ? ((u.pickerHTML =
                    ...
                    u.pickerHTML +
                    '</div></div>'),
                  (u.popover = t.popover(u.pickerHTML, u.params.input, !0)),
                  (u.container = t(u.popover).find('.weui-picker-modal')),
                  t(u.popover).on('close', function() {
                    l()
                  }))
                : u.inline
                ? ((u.container = t(u.pickerHTML)),
                  u.container.addClass('picker-modal-inline'),
                  t(u.params.container).append(u.container))
                : ((u.container = t(t.openPicker(u.pickerHTML))),
                  t(u.container).on('close', function() {
                    l()
                  })),
              (u.container[0].f7Calendar = u),
              (u.wrapper = u.container.find('.picker-calendar-months-wrapper')),
              (u.months = u.wrapper.find('.picker-calendar-month')),
              u.updateCurrentMonthYear(),
              (u.monthsTranslate = 0),
              u.setMonthsTranslate(),
              u.initCalendarEvents(),
              n && u.updateValue()),
              (u.opened = !0),
              (u.initialized = !0),
              u.params.onMonthAdd &&
                u.months.each(function() {
                  u.params.onMonthAdd(u, this)
                }),
              u.params.onOpen && u.params.onOpen(u)
          }),
          (u.close = function() {
            if (u.opened && !u.inline)
              return (
                (u.animating = !1),
                r()
                  ? void t.closePicker(u.popover)
                  : void t.closePicker(u.container)
              )
          }),
          (u.destroy = function() {
            u.close(),
              u.params.input &&
                u.input.length > 0 &&
                (u.input.off('click focus', s), u.input.data('calendar', null)),
              t('html').off('click', c)
          }),
          u.inline && u.open(),
          u
    ...
    ;(t.fn.calendar = function(e, n) {
      ...
      (e = t.fn.calendar.prototype.defaults = {
        ...
        toolbarCloseText: '清空',
        toolbarTemplate:
          '<div class="toolbar"><div class="toolbar-inner">{{yearPicker}}{{monthPicker}}<a href="javascript:;" class="link close-picker">{{closeText}}</a></div></div>'
      })
  })($),
  +(function(t) {
    'use strict'
        ...
        var t,
          ...
          r = {
            ...
            cols: [
              {
                values: (function() {
                  for (var t = [], e = 1950; e <= 2050; e++) t.push(e)
                  return t
                })()
              },
  ...
  +(function(t) {
    ...
    ;(t.openPopup = function(e, n) {
      ...
      t(document)
        .on('click', '.close-popup, .weui-popup-overlay', function() {
          t.closePopup()
        })
  ...
  +(function(t) {
    ...
    ;(t.notification = t.noti = function(a) {
      ;(a = t.extend({}, n, a)),
        (e = t('.notification')),
        e[0] ||
          ((e = t('<div class="notification"></div>').appendTo(document.body)),
          u(e)),
        e.off('noti-click'),
        a.onClick &&
      ...
      (n = t.noti.prototype.defaults = {
        ...
        data: void 0,
        tpl:
          '<div class="notification-inner">{{#if media}}<div class="notification-media">{{media}}</div>{{/if}}<div class="notification-content">{{#if title}}<div class="notification-title">{{title}}</div>{{/if}}{{#if text}}<div class="notification-text">{{text}}</div>{{/if}}</div><div class="notification-handle-bar"></div></div>'
      })
  })($),
  +(function(t) {
    'use strict'
    ...
    t.toptip = function(n, i, a) {
      if (n) {
        ...
        ;(o = t('<div class="weui_toptips"></div>').appendTo(document.body)),
          ...
          clearTimeout(e),
          o.hasClass('weui_toptips_visible') ||
            (o.show().width(), o.addClass('weui_toptips_visible')),
